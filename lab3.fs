...
//5 Ïîñëåäîâàòåëüíî ïðèìåíèòå ê ñïèñêó ôóíêöèè map, sort, filter, fold, zip,
//ôóíêöèè àãðåãèðîâàíèÿ.
//5_1 
let Fn5()=
...
let menu()=
    ...
    while work do
        ...
        1 - Çàäàíèå 1
        2 - Çàäàíèå 2
        3 - Ñ èñïîëüçîâàíèåì list comprehension äëÿ ÷åòíûõ ýëåìåíòîâ âåðíóòü ýëåìåíò, êâàäðàò è êóá â âèäå ñïèñêà
        4 - Çàäàíèå 4
        5 - 3 êîìáèíàöèè map, sort, filter, fold, zip, ôóíêöèè àãðåãèðîâàíèÿ
        6 - Ðåàëèçóéòå ïðåäûäóùèé ïóíêò ñ èñïîëüçîâàíèåì îïåðàòîðà ïîòîêà « |> »
        7 - Ðåàëèçóéòå ïðåäûäóùèé ïóíêò ñ èñïîëüçîâàíèåì îïåðàòîðà êîìïîçèöèè ôóíêöèé « >> »
=============================================="
